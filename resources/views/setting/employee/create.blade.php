                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <select name="title" class="select select2 form-control" required data-parsley-required-message="เลือกคำนำหน้า" data-parsley-trigger="focusout" placeholder="" data-parsley-errors-container="#title-required">
                                ...
                                <option value="{{$titlename->name}}">{{$titlename->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="firstname" value="{{old('firstname')}}" class="form-control firstname" required data-parsley-required-message="กรอกชื่อ" data-parsley-trigger="focusout" placeholder="ชื่อ" data-parsley-errors-container="#firstname-required" >
                                @if ($errors->has('firstname'))
                                    <span class="help-block">
                                        <strong class="validate-message">{{ $errors->first('firstname') }}</strong>
                                    </span>
                                @endif
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="lastname" value="{{old('lastname')}}" class="form-control lastname" required data-parsley-required-message="กรอกนามสกุล" data-parsley-trigger="focusout" placeholder="นามสกุล" data-parsley-errors-container="#lastname-required" >
                                @if ($errors->has('lastname'))
                                    <span class="help-block">
                                        <strong class="validate-message">{{ $errors->first('lastname') }}</strong>
                                    </span>
                                @endif
