...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{url('issue/closed')}}">Job Closed</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            <span>Edit</span>
...
<div class="row {{$issuereqs->step4 ==1 ? 'lockscreen':''}}">
    <div class="">
        <div class="row portlet-title">
            <div class="col-lg-12">
                <div class="caption">
                    <h3><i class="fa fa-calendar-plus-o"></i> NC RAW MATERIAL TIMELINE
                    <span class="pull-right">
                        @if($issuereqs->step4 ==1)
                            <img src="{{url('images/closed.png')}}" alt="" class="img-responsive" style="width:200px;">
                        @endif
                    </span>
                    </h3>
        ...
        <br>
        <div class="row">
            <div class="col-lg-6 {{Auth::user()->department_code == 'pu' ? 'lockscreen':''}}">

                <div class="portlet light bordered customheight1">

                    <legend class="m-heading-1 m-bordered
                                    {{$issuereqs->step1==1?'border-green':'border-grey'}}
                                ">Progress 25% : Incoming</legend>
            ...
            <div class="col-lg-6 {{(Auth::user()->department_code =='inc' || $issuereqs->step1 == 0)?'lockscreen':''}}">
                        ...
                        <div class="portlet-body form">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" name="file_doc" value="{{$issuereqs->file_doc}}" class="form-control filedoc"
                                        readonly="readonly">

                                    <div class="form-group">
                                        <label class="control-label col-lg-3 col-md-3"><strong>การดำเนินการของฝ่ายจัดซื้อ </strong><span class="required">*</span></label>
                                        <div class="col-lg-9 col-md-9">
                                            <textarea name="pu_process" cols="10" rows="3" class="form-control" required data-parsley-required-message="กรอกการดำเนินการของฝ่ายจัดซื้อ"
                                  ...
                                  <i class="fa fa-calendar"></i>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-md-9">
                                            ...
                                            <textarea name="pu_process_supplier" id="pu_process_supplier" cols="10" rows="3" class="form-control" required data-parsley-required-message="กรอกการดำเนินการของ Supplier"
        ...
        <div class="row">
            ...
            <div class="col-lg-6 {{(Auth::user()->department_code=='pu' || $issuereqs->step2 ==0)?'lockscreen':''}}">
                        ...
                        <div class="portlet-body form">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-3 col-md-3"><strong>เอกสารแนบ FM-IN-007</strong><span class="required">*</span> <span class="required">(xls, pdf ขนาดไม่เกิน 2 Mb.)</span></label>
            ...
            <div class="col-lg-6 {{(Auth::user()->department_code=='inc' || $issuereqs->step3==0)?'lockscreen':''}}">
                ...
                <div class="portlet light bordered customheight2">
                    <legend class="m-heading-1 m-bordered 
                                ...
                                ">Progress 100% : Purchasing</legend>
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('issue/request') }}/{{$issuereqs->id}}/edit" data-parsley-validate=""
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <input type="number" step="any" min="0" max="100000000" name="volume_damage" value="{{$issuereqs->volume_damage}}" class="form-control" required data-parsley-required-message="กรอกปริมาณความเสียหาย"
                                                data-parsley-trigger="focusout" placeholder="" data-parsley-type="number" data-parsley-errors-container="#voldam-required"
                      ...
                      @endforeach
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <input type="number" step="any" min="0" max="100000000" name="pu_amount" value="{{$issuereqs->pu_amount}}" class="form-control" required data-parsley-required-message="กรอกจำนวนเงิน"
                                                data-parsley-trigger="focusout" placeholder="" data-parsley-errors-container="#amount-required">
