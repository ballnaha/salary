...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{url('issue/request')}}">Job Open</a>
        </li>
    </ul>
</div>
@endsection
...
<div class="portlet light portlet-fit portlet-datatable bordered">
    <div class="portlet-title">
        <div class="row">
            <div class="col-md-6">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">รายงานการแจ้งปัญหาและการออกจดหมายเคลม</span> -->
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="">
                    @if((Auth::user()->department_code != 'pu')&&(Auth::user()->role == 10))
                    <a href="{{url('issue/request/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Create</a>
                    @endif
                </div>
            </div>
            <div class="col-md-offset-3 col-md-3">
                <a href="javascript:;" class="btn dark btn-outline statusbtn">Waiting Incoming</a>
                <a href="javascript:;" class="btn dark btn-outline statusbtn">Waiting PU</a>
                <a href="" type="reset" class="btn dark btn-outline">All</a>
                    ...
                    <table class="table table-bordered table-striped" id="issuereqtable" width="100%" height="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="min-width: 95px;">FM-IN-126 No.</th>
                                <th class="text-center" style="min-width: 100px;">วันที่ออกเอกสาร</th>
                                <th class="text-center" style="min-width: 50px;">ปัญหา</th>
                                <th class="text-center" style="min-width: 40px;">อาคาร</th>
                                <th class="text-center" style="min-width: 150px;">Supplier Name</th>
                                <th class="text-center" style="min-width: 200px;">รายละเอียดของปัญหา</th>
                                <th class="text-center" style="min-width: 200px;">การดำเนินการของฝ่ายจัดซื้อ</th>
                                <th class="text-center" style="min-width: 80px;">Supplier Notification Date </th>
                                <th class="text-center" style="min-width: 200px;">การดำเนินการของ Supplier</th>
                                ...
                                {{-- <th class="text-center bg-purple-medium" style="min-width: 80px;">Claim No.</th>
                                <th class="text-center bg-purple-medium" style="min-width: 80px;">Return No.</th>
                                <th class="text-center bg-purple-medium" style="min-width: 80px;">ปริมาณความเสียหาย</th>
                                <th class="text-center bg-purple-medium" style="min-width: 80px;">จำนวนเงิน</th>
                                <th class="text-center bg-purple-medium" style="min-width: 80px;">ใบลดหนี้/เชค No.</th>
                                <th class="text-center bg-purple-medium" style="min-width: 80px;">Closed Date</th> --}}
                            </tr>
                        </thead>
                    </table>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">FM-IN-126 NO. : {{$issuereq->file_doc}}</h4>
            </div>
...
fixedHeader: false ,
buttons: [
// { extend: 'print', className: 'btn dark btn-outline', title: 'Open Job',text:'<i class="fa fa-print"></i> Print',
// exportOptions: {
